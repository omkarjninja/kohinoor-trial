...
const Final = () => {
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12  bg-[#f2f0ef]">
            <div className="flex flex-col items-center justify-center">
                <div>
                <Image src={klarge} alt="" className="logo-av pt-2 pb-2" style={{width:"160px",height:"160px"}}/>
                </div>
                ...
                <div className="flex items-center gap-x-8 mt-6">
                    ...
                    <div className="cursor-pointer" onClick={() => window.open("https://www.instagram.com/kohinoor_watches.__/")}>
                        <svg className="fill-current text-[#7b3911] hover:text-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
