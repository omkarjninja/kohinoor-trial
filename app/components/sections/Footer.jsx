        ...
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4   bg-[#f2f0ef]">
            <div className=" text-center">
                ...
                <p className=" font-normal text-base leading-6 text-gray-600 mt-4 lg:w-5/12 md:w-9/12 mx-auto">
                   <a href="https://www.instagram.com/kohinoor_watches.__/" target="_blank">Follow us on instagram <span className="underline cursor-pointer text-[#7b3911]">@Kohinoor Watches</span> and tag us to get featured on our timeline</a> 
                </p>
            </div>
